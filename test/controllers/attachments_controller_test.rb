...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference("Attachment.count") do
      post attachments_url, params: { attachment: { filename: @attachment.filename, task_id: @attachment.task_id, url: @attachment.url } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { filename: @attachment.filename, task_id: @attachment.task_id, url: @attachment.url } }
